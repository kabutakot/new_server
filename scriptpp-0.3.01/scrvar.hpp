...
/*! This class implements a common intuitive-clear notion of a string.
   ...
   \note
    ...
    (internally it is the NULL pointer).
 */
...
public:
    ...
    ScriptVariable();
        ...
        /*! If you for some reason can make some estimations about how
            ...
            Passing -1 will produce an invalid object.
         */
    ...
    bool GetLongLong(long long &l) const /* throw () */;
    bool GetDouble(double &d) const /* throw () */;

    long GetLong() const /* throw (BadNumber) */;
    long long GetLongLong() const /* throw (BadNumber) */;
...
public:
    ...
    ScriptNumber(long long int i) : ScriptVariable(0, "%lld", i) {}
    ScriptNumber(unsigned long long int i) : ScriptVariable(0, "%llu", i) {}
...
public:
    ScriptVariableInv() : ScriptVariable(-1) {}
